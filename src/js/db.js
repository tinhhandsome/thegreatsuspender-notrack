          ...
          (function (local) {
            ...
            function mongoifyKey(key) {
              if (
                ...
                var _mongoDBToKeyRangeArg2 = _slicedToArray(
                  _mongoDBToKeyRangeArg,
                  2
                );
            ...
            var IndexQuery = function IndexQuery(
              table,
              db,
              indexName,
              preexistingError
              ...
              var Query = function Query(type, args, queuedError) {
                ...
                var limit = function limit(start, end) {
                  ...
                  error = limitRange.some(function (val) {
                    ...
                    ? new Error("limit() arguments must be numeric")
                    : error;
              ...
              ["only", "bound", "upperBound", "lowerBound"].forEach(function (
                name
              ) {
                _this[name] = function () {
              ...
              this.range = function (opts) {
                ...
                return Query.apply(
                  undefined,
                  _toConsumableArray(keyRange).concat([error])
                );
              };
            ...
            var Server = function Server(db, name, version, noServerMethods) {
              ...
              this.query = function (table, index) {
                var error = closed
                  ? new Error("Database has been closed")
                  : null;
              ...
              [].some.call(db.objectStoreNames, function (storeName) {
                if (_this2[storeName]) {
                  err = new Error(
                    'The store name, "' +
                      storeName +
                      '", which you have attempted to load, conflicts with db.js method names."'
                  );
                  _this2.close();
                  return true;
                }
                ...
                Object.keys(table.indexes || {}).some(function (indexKey) {
                  try {
                    ...
                    try {
                      store.createIndex(
                        indexKey,
                        index.keyPath || index.key || indexKey,
                        index
                      );
                    } catch (err2) {
                      ret = err2;
                  ...
                  if (dbCache[server][version]) {
                    ...
                    var _ret2 = (function () {
                      ...
                      request.onsuccess = function (e) {
                        return _open(e, server, version, noServerMethods).then(
                          resolve,
                          reject
                        );
                      };
                      ...
                      request.onblocked = function (e) {
                        var resume = new Promise(function (res, rej) {
                          ...
                          request.onsuccess = function (ev) {
                            _open(ev, server, version, noServerMethods).then(
                              res,
                              rej
                            );
                          };
              ...
              delete: function _delete(dbName) {
                return new Promise(function (resolve, reject) {
                  ...
                  request.onblocked = function (e) {
                    ...
                    e =
                      e.newVersion === null || typeof Proxy === "undefined"
                        ? e
                        : new Proxy(e, {
